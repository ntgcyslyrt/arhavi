...
if Student.count == 0
  ...
  Student.create(:tc => '12345678001', :first_name => 'Canan', :last_name => 'Demirel', :email => 'kcd@bil.omu.edu.tr', :password => '123456', :phone_number => '0542 111 11 11', :gender => "Kadin", :birthday => "15-02-1990", :address => "Foo Mah. Bar Sok. No:42 Baz/Samsun", :city_id => 52, :district_id => 3)
end
if Role.count == 0
